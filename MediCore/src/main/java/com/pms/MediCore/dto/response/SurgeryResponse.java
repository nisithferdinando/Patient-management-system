...
public class SurgeryResponse {
    ...
    public SurgeryResponse() {
    }

    public SurgeryResponse(Long id, Long surgeryType, String description, Long patientId, Long admissionId, String patientRegNo, Long primaryDoctorId, Long doctorId, Long theaterNo, Date surgeryDate, Long active, Long status, Date createdDate, Date updatedDate) {
        this.id = id;
