...
public class PatientRequest {
    ...
    public PatientRequest(Long id, String firstName, String lastName, Long state, Long gender, Long age,
                          Long active, Date dateOfBirth, String contactNo, String email, String country, String stateName,
                          String addressNo, String address, Date regDate, Time regTime, String relationName, String relationNo, String emergencyContactNo, Long relationState){
        this.id = id;
        //this.regNo = regNo;
