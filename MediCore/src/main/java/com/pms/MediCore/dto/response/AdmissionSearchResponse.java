...
public class AdmissionSearchResponse {
    ...
    public AdmissionSearchResponse(){

    }
    public AdmissionSearchResponse(Long admissionId, String regNo, String stateName, String fullName,
